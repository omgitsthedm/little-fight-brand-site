              ...
              <div className="floors absolute inset-0">
                {building.services.map((service, floorIndex) => {
                  ...
                  return (
                    <div
                      key={floorIndex}
                      className="service-floor absolute left-0 w-full h-[44px] border-t-2 border-l-2 border-r-2 border-[#bc4905] grid place-items-center transition-all duration-500"
                      style={{
                    ...
                    >
                      ...
                      {/* Floor Label */}
                      <span 
                        className={`floor-label relative z-10 text-[10px] font-extrabold uppercase tracking-wide text-white px-2 py-0.5 rounded-full bg-black/30 transition-opacity duration-200 ${isVisible ? 'opacity-100' : 'opacity-0'}`}
